/*
  ==============================================================================
    ...
    AudioWaveformChannelOpenGLComponent.cpp
...
void AudioWaveformChannelOpenGLComponent::initialise (
...
void AudioWaveformChannelOpenGLComponent::render (OpenGLContext& openGLContext)
{
...
void AudioWaveformChannelOpenGLComponent::load (const float* samples)
{
    samplesArray = samples;
}

void AudioWaveformChannelOpenGLComponent::display (
...
void AudioWaveformChannelOpenGLComponent::calculateVertices ()
{
...
AudioWaveformChannelOpenGLComponent::VertexBuffer::VertexBuffer (
    OpenGLContext& openGLContext
) :
    openGLContext (openGLContext)
{
...
void AudioWaveformChannelOpenGLComponent::VertexBuffer::bind (
    Array<Vertex>& buffer)
{
...
void AudioWaveformChannelOpenGLComponent::VertexBuffer::unbind ()
{
